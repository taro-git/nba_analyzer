...
export default function Game({ loaderData }: Route.ComponentProps) {
  ...
  // States
  // ----------------------------------------------------------------------
  const [elapsedMsRange, setElapsedMsRange] = useState<number[]>(Array(2).fill(Math.min(...elapsedMillisecounds)));
  ...
  const summaryTableData = (Object.keys(statsTableHeaderNames) as (keyof TableData)[])
                ...
                return isCurrent ? (
                  ...
                  >
                    <GameCard
                      ...
                      gameSummary={game}
                      inactive={true}
                      homeScore={homeBoxScoreData.filter((d) => d.isTeam)[0].points}
                      awayScore={awayBoxScoreData.filter((d) => d.isTeam)[0].points}
                    />
                  </div>
                ) : (
